...
[For example, we may satisfy this condition by choosing $\Set_n$ for each $n$ to be the von Neumann universe $V_{\omega \times (n + 1)}$ of sets of rank less than $\omega \times (n + 1)$. Many other possibilities are available, this is only one suggestion.]
